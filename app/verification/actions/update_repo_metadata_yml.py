...
class WorkflowsFileUpdateRepoMetadataYMLVerification(VerificationInterface):
    KEY = 'git.workflows.file.update_repo_metadata_yml'
    RULE_DESCRIPTION = "Verifica o arquivo .github/workflows/update-repo-metadata.yml"
    ...
    def verify(cls, repository: Repository, config: InspectorConfig) -> RepoVerificationResult:
        file_name = '.github/workflows/update-repo-metadata.yml'
